...
protected:
  ...
  BitSet(const BitSet& x, const BitSet& y, enum BS_op op)
    { rep = BitSetop (x.rep, y.rep, (BitSetRep *) NULL, (char) op);  }
  BitSet(const BitSet& x, enum BS_op /* op */)
    { rep = BitSetcmpl (x.rep, (BitSetRep *) NULL); }
...
// convertors & IO
  ...
  friend void        and_(const BitSet& x, const BitSet& y, BitSet& r);
  friend void        or_(const BitSet& x, const BitSet& y, BitSet& r);
  friend void        xor_(const BitSet& x, const BitSet& y, BitSet& r);
...
#ifndef __STRICT_ANSI__
inline void and_(const BitSet& x, const BitSet& y, BitSet& r)
{
  r.rep =  BitSetop(x.rep, y.rep, r.rep, '&');
}

inline void or_(const BitSet& x, const BitSet& y, BitSet& r)
{
  r.rep =  BitSetop(x.rep, y.rep, r.rep, '|');
}

inline void xor_(const BitSet& x, const BitSet& y, BitSet& r)
{
  r.rep =  BitSetop(x.rep, y.rep, r.rep, '^');
}
