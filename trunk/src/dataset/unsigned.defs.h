...
#ifndef _unsigneddefs_h
#define _unsigneddefs_h 1


// equality operator
#ifndef unsignedEQ
#define unsignedEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef unsignedLE
#define unsignedLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef unsignedCMP
#define unsignedCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef unsignedHASH
extern unsigned int hash(unsigned );
#define unsignedHASH(x)  hash(x)
#endif
