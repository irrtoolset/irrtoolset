...
#ifndef _CacheKeydefs_h
#define _CacheKeydefs_h 1
#include "config.h"
#include "irr/cache_value.hh"

// equality operator
#ifndef CacheKeyEQ
#define CacheKeyEQ(a, b)  ((a) == (b))
#endif

// less-than-or-equal
#ifndef CacheKeyLE
#define CacheKeyLE(a, b)  ((a) <= (b))
#endif

// comparison : less-than -> < 0; equal -> 0; greater-than -> > 0
#ifndef CacheKeyCMP
#define CacheKeyCMP(a, b) ( ((a) <= (b))? (((a) == (b))? 0 : -1) : 1 )
#endif

// hash function
#ifndef CacheKeyHASH
extern unsigned int hash(CacheKey );
#define CacheKeyHASH(x)  hash(x)
#endif
